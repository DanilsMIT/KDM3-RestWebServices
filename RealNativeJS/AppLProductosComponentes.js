...
import { StyleSheet, Text, View, FlatList, TextInput, Button, Alert, ScrollView, Modal, TouchableHighlight } from 'react-native';
let productos = [
            ...
            <View style={styles.elementoBOX}>
                ...
                >
                    <View style={styles.modalView}>
                        <Text>Seguro de Eliminar el Producto?</Text>
                        <Button
                            title='SI'
                            color='green'
                            onPress={() => {
